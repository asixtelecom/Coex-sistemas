...
export function SettingsOverview({
  ...
  const tiles: {
        ...
        counts?.members == null
          ...
          : `${counts.members} membro${counts.members === 1 ? '' : 's'}${
              counts.pendingInvites
                ? ` · ${counts.pendingInvites} convite${counts.pendingInvites === 1 ? '' : 's'} pendente${counts.pendingInvites === 1 ? '' : 's'}`
                : ''
            }`,
    },
    {
    ...
    },
    {
      section: 'appearance',
      loading: false,
      subtitle: `Modo ${cap(mode)} · Tema ${themeName}`,
    },
  ];
