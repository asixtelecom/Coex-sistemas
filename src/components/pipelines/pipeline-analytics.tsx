    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-border bg-card/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        <Metric
          ...
          tooltip="Contagem de todos os negócios neste pipeline que não estão marcados como Perdidos. Negócios ganhos ainda estão incluídos."
        />
        <Metric
        ...
        <Metric
          ...
          tooltip="Receita esperada: valor de cada negócio aberto × sua probabilidade de etapa. Primeira etapa ≈ 10%, etapas progridem até 90%, Ganho = 100%. Negócios perdidos são excluídos."
        />
        <Metric
